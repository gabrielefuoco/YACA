...
module.exports = {
    ...
    FAST_CATALOG_PAGE1_L2_TTL_MS: 2 * 24 * 60 * 60 * 1000,  // 2 days
    FAST_CATALOG_PAGE1_SWR_MS: 15 * 60 * 1000,              // 15 min SWR
    FAST_CATALOG_DEEP_L2_TTL_MS: 2 * 24 * 60 * 60 * 1000,   // 2 days
    FAST_CATALOG_DEEP_SWR_MS: 15 * 60 * 1000,               // 15 min SWR
    // Slow catalogs (Top Rated, Oscar, Decades)
    SLOW_CATALOG_L2_TTL_MS: 3 * 24 * 60 * 60 * 1000,       // 3 days
    SLOW_CATALOG_SWR_MS: 12 * 60 * 60 * 1000,               // 12 hours SWR

    // Legacy aliases (kept for backward compat)
    CACHE_TTL_MS: 3 * 24 * 60 * 60 * 1000, // 3 giorni (default)

    // ─── Metadata Cache (single items) ───
    // Movies (completed)
    MOVIE_META_CACHE_TTL_MS: 3 * 24 * 60 * 60 * 1000,     // 3 days L2
    MOVIE_META_SWR_MS: 3 * 24 * 60 * 60 * 1000,             // 3 days SWR
    ...
    RECOMMENDATIONS_CACHE_TTL_MS: 2 * 24 * 60 * 60 * 1000,  // 2 giorni
    RECOMMENDATIONS_SWR_MS: 60 * 60 * 1000,                 // 1 ora SWR

    // Deep Enrichment Settings (Fase 9)

    MOVIE_PRESENTATION_TTL_MS: 3 * 24 * 60 * 60 * 1000,  // 3 days base TTL for movies
    MOVIE_PRESENTATION_SWR_MS: 3 * 24 * 60 * 60 * 1000,   // 3 days SWR window for movies
