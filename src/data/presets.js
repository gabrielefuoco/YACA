...
const getPresets = () => {
    ...
    const rawPresets = [
        ...
        { id: 'preset_giant_monsters', name: 'Squali & Mostri Giganti', emoji: '🦖', category: "👻 Brivido & Paura", type: 'movie', presentation_strategy: 'popularity', queries: [{ strategy: 'discovery', with_keywords: '10466|156095|257007|12335', sort_by: 'popularity.desc', 'vote_count.gte': 50 }] },
        ...
        { id: 'preset_extreme_survival', name: 'Sopravvivenza Estrema', emoji: '🏕️', category: "💥 Adrenalina & Avventura", type: 'movie', presentation_strategy: 'popularity', queries: [{ strategy: 'discovery', with_keywords: '4564|285366|3335', sort_by: 'vote_average.desc', 'vote_count.gte': 200 }] },
        ...
        { id: 'preset_animal_protagonists', name: 'Animali Protagonisti', emoji: '🐾', category: '👨‍👩‍👧‍👦 Bambini & Famiglia', type: 'movie', presentation_strategy: 'popularity', queries: [{ strategy: 'discovery', with_genres: 10751, with_keywords: '10574|6054|11303', without_keywords: '210024', sort_by: 'popularity.desc', 'vote_count.gte': 20 }] },
