...
const getPresets = () => {
    ...
    return [
        ...
        // =============================================
        { id: 'preset_nature_docs', name: 'Documentari: Natura e Animali', emoji: '🌿', category: "🌍 Documentari & Storie Vere", type: 'movie', presentation_strategy: 'popularity', queries: [{ strategy: 'discovery', with_genres: TMDB_GENRES.MOVIE.Documentary, with_keywords: '818|2964|2271|9882', sort_by: 'vote_average.desc', 'vote_count.gte': 200 }] },
        { id: 'preset_space_docs', name: 'Documentari: Cosmo e Spazio', emoji: '🚀', category: "🌍 Documentari & Storie Vere", type: 'movie', presentation_strategy: 'popularity', queries: [{ strategy: 'discovery', with_genres: TMDB_GENRES.MOVIE.Documentary, with_keywords: '3801|161176|173161|3388', sort_by: 'vote_average.desc', 'vote_count.gte': 200 }] },
        ...
        { id: 'preset_doc_history_war', name: 'Storia & Guerre Mondiali', emoji: '🪖', category: "🌍 Documentari & Storie Vere", type: 'series', presentation_strategy: 'popularity', queries: [{ strategy: 'discovery', with_genres: TMDB_GENRES.TV.Documentary, with_keywords: '273967|282633|195232|3573', sort_by: 'vote_average.desc', 'vote_count.gte': 100 }] },
        ...
        { id: 'preset_teen_preteen_tv', name: 'Teen & Pre-Teen TV (Live)', emoji: '🎒', category: '👨‍👩‍👧‍👦 Bambini & Famiglia', type: 'series', presentation_strategy: 'popularity', queries: [{ strategy: 'discovery', with_genres: '10762|35', without_genres: 16, without_keywords: '210024', sort_by: 'popularity.desc', 'vote_count.gte': 20, without_original_language: 'ko|zh|th|hi|te|ta' }] },
        { id: 'preset_fairy_tales', name: 'Fiabe, Castelli & Principesse', emoji: '🧚', category: '👨‍👩‍👧‍👦 Bambini & Famiglia', type: 'movie', presentation_strategy: 'popularity', queries: [{ strategy: 'discovery', with_keywords: '3205|3095|12554', without_keywords: '210024', sort_by: 'popularity.desc', 'vote_count.gte': 50, without_original_language: 'ko|zh|th|hi|te|ta' }] },
