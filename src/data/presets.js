...
const getPresets = () => {
    ...
    const rawPresets = [
        ...
        { id: 'preset_whodunit', name: 'Whodunit & Indagini', emoji: '🔎', category: "🕵️ Crimine, Mistero & Thriller", type: 'movie', presentation_strategy: 'popularity', queries: [{ strategy: 'discovery', with_genres: '9648|80', with_keywords: '12570|207046', sort_by: 'popularity.desc', 'vote_count.gte': 50 }] },
        { id: 'preset_whodunit_series', name: 'Whodunit & Indagini (Serie)', emoji: '🔎', category: "🕵️ Crimine, Mistero & Thriller", type: 'series', presentation_strategy: 'popularity', queries: [{ strategy: 'discovery', with_genres: `${TMDB_GENRES.TV.Mystery}|${TMDB_GENRES.TV.Crime}`, with_keywords: '12570|207046', sort_by: 'popularity.desc', 'vote_count.gte': 15, without_keywords: '210024' }] },
        ...
        // =============================================
        { id: 'preset_miniseries', name: 'Miniserie di Qualità', emoji: '📺', category: "🕵️ Crimine, Mistero & Thriller", type: 'series', presentation_strategy: 'popularity', queries: [{ strategy: 'discovery', with_genres: TMDB_GENRES.TV.Drama, with_keywords: '11162', sort_by: 'vote_average.desc', 'vote_count.gte': 100, without_keywords: '210024' }] },
