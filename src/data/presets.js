...
const getPresets = () => {
    ...
    const rawPresets = [
        ...
        { id: 'preset_slasher_gore', name: 'Slasher & Splatter Gore', emoji: '🪓', category: "👻 Brivido & Paura", type: 'movie', presentation_strategy: 'popularity', queries: [{ strategy: 'discovery', with_genres: TMDB_GENRES.MOVIE.Horror, with_keywords: '12339|10714|10292|14546|12394', sort_by: 'popularity.desc', 'vote_count.gte': 50, without_keywords: '12377|3133' }] },
        ...
        { id: 'preset_tv_superheroes_dark', name: 'Supereroi (Toni Oscuri)', emoji: '🦸‍♂️', category: "🐉 Fantascienza & Fantasy", type: 'series', presentation_strategy: 'popularity', queries: [
            { strategy: 'discovery', with_genres: `${TMDB_GENRES.TV.ActionAdventure}|${TMDB_GENRES.TV.Crime}|${TMDB_GENRES.TV.Drama}`, without_genres: `${TMDB_GENRES.TV.Kids},10751`, with_keywords: '9715,2095', sort_by: 'vote_average.desc', 'vote_count.gte': 50 },
            { strategy: 'discovery', with_genres: `${TMDB_GENRES.TV.ActionAdventure}|${TMDB_GENRES.TV.Crime}|${TMDB_GENRES.TV.Drama}`, without_genres: `${TMDB_GENRES.TV.Kids},10751`, with_keywords: '9715,259094', sort_by: 'vote_average.desc', 'vote_count.gte': 50 },
            { strategy: 'discovery', with_genres: `${TMDB_GENRES.TV.ActionAdventure}|${TMDB_GENRES.TV.Crime}|${TMDB_GENRES.TV.Drama}`, without_genres: `${TMDB_GENRES.TV.Kids},10751`, with_keywords: '9715,7002', sort_by: 'vote_average.desc', 'vote_count.gte': 50 }
        ] },
