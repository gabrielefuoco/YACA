...
const getPresets = () => {
    ...
    const rawPresets = [
        ...
        { id: 'preset_vampires_werewolves', name: 'Vampiri & Lupi Mannari', emoji: '🧛', category: "👻 Brivido & Paura", type: 'movie', presentation_strategy: 'popularity', queries: [{ strategy: 'discovery', with_keywords: '3133|12377|12564|12377', sort_by: 'popularity.desc', 'vote_count.gte': 50 }] },
        ...
        { id: 'preset_psych_thriller', name: 'Thriller Psicologici', emoji: '😱', category: "🕵️ Crimine, Mistero & Thriller", type: 'movie', presentation_strategy: 'popularity', queries: [{ strategy: 'discovery', with_genres: 53, with_keywords: '15001|12377|12988|10391', sort_by: 'popularity.desc', 'vote_count.gte': 100 }] },
        ...
        { id: 'preset_zombies', name: 'Zombie & Infezioni', emoji: '🧟', category: "👻 Brivido & Paura", type: 'series', presentation_strategy: 'popularity', queries: [{ strategy: 'discovery', with_keywords: '12377|4565|10483', with_genres: TMDB_GENRES.TV.SciFiFantasy, sort_by: 'popularity.desc', 'vote_count.gte': 10, without_keywords: '210024' }] },
        { id: 'preset_zombies_movies', name: 'Zombie & Infezioni (Film)', emoji: '🧟', category: "👻 Brivido & Paura", type: 'movie', presentation_strategy: 'popularity', queries: [{ strategy: 'discovery', with_keywords: '12377|4564|10483', with_genres: '27|878', sort_by: 'popularity.desc', 'vote_count.gte': 50 }] },
