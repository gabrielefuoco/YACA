...
const getPresets = () => {
    ...
    const rawPresets = [
        ...
        { id: 'preset_zombies', name: 'Zombie & Infezioni', emoji: '🧟', category: "👻 Brivido & Paura", type: 'series', presentation_strategy: 'popularity', queries: [{ strategy: 'discovery', with_keywords: '12377|9744', with_genres: TMDB_GENRES.TV.SciFiFantasy, sort_by: 'popularity.desc', 'vote_count.gte': 10, without_keywords: '210024' }] },
