...
const getPresets = () => {
    ...
    return [
        ...
        { id: 'preset_pop_anime', name: 'Anime Popolari', emoji: '🌟', category: "🏮 Solo Anime", type: 'series', presentation_strategy: 'popularity', queries: [{ strategy: 'discovery', with_original_language: 'ja', with_genres: TMDB_GENRES.TV.Animation, sort_by: 'popularity.desc', 'vote_count.gte': 100, without_keywords: '198385,353318,214564,360629,284535,256466,356759' }] },
        ...
        // =============================================
        { id: 'preset_anime_simulcast', name: 'Simulcast (Nuovi Episodi)', emoji: '📺', category: "🏮 Solo Anime", type: 'series', presentation_strategy: 'popularity', showEpisodeBadge: true, queries: [{ provider: 'anilist', strategy: 'simulcast' }] },
        { id: 'preset_anime_shonen', name: 'Anime: Battle Shōnen', emoji: '🔥', category: "🏮 Solo Anime", type: 'series', presentation_strategy: 'popularity', queries: [{ strategy: 'discovery', with_genres: TMDB_GENRES.TV.Animation, with_keywords: '207826', with_original_language: 'ja', sort_by: 'popularity.desc' }] },
        { id: 'preset_anime_seinen', name: 'Anime: Seinen (Maturi)', emoji: '🍷', category: "🏮 Solo Anime", type: 'series', presentation_strategy: 'popularity', queries: [{ strategy: 'discovery', with_genres: TMDB_GENRES.TV.Animation, with_keywords: '195668', with_original_language: 'ja', sort_by: 'vote_average.desc', 'vote_count.gte': 50 }] },
        { id: 'preset_anime_shoujo', name: 'Anime: Shōjo (Romantico)', emoji: '🌸', category: "🏮 Solo Anime", type: 'series', presentation_strategy: 'popularity', queries: [{ strategy: 'discovery', with_genres: TMDB_GENRES.TV.Animation, with_keywords: '206437', with_original_language: 'ja', sort_by: 'popularity.desc' }] },
        { id: 'preset_anime_slice_of_life', name: 'Anime: Slice of Life', emoji: '☕', category: "🏮 Solo Anime", type: 'series', presentation_strategy: 'popularity', queries: [{ strategy: 'discovery', with_genres: TMDB_GENRES.TV.Animation, with_keywords: '9914', with_original_language: 'ja', sort_by: 'vote_average.desc', 'vote_count.gte': 50 }] },
        { id: 'preset_anime_mecha', name: 'Anime: Mecha & Robot', emoji: '🤖', category: "🏮 Solo Anime", type: 'series', presentation_strategy: 'popularity', queries: [{ strategy: 'discovery', with_genres: TMDB_GENRES.TV.Animation, with_keywords: '10046', with_original_language: 'ja', sort_by: 'popularity.desc' }] },
        { id: 'preset_anime_isekai', name: 'Anime: Isekai & Fantasy', emoji: '🌀', category: "🏮 Solo Anime", type: 'series', presentation_strategy: 'popularity', queries: [{ strategy: 'discovery', with_genres: TMDB_GENRES.TV.Animation, with_keywords: '237451', with_original_language: 'ja', sort_by: 'popularity.desc' }] },
        { id: 'preset_anime_dark', name: 'Anime: Dark & Psicologico', emoji: '💀', category: "🏮 Solo Anime", type: 'series', presentation_strategy: 'popularity', queries: [{ strategy: 'discovery', with_genres: TMDB_GENRES.TV.Animation, with_keywords: '259094|272553', with_original_language: 'ja', sort_by: 'vote_average.desc', 'vote_count.gte': 50 }] },
        { id: 'preset_anime_action', name: 'Anime: Azione & Combattimento', emoji: '💥', category: "🏮 Solo Anime", type: 'series', presentation_strategy: 'popularity', queries: [{ strategy: 'discovery', with_genres: `${TMDB_GENRES.TV.Animation},${TMDB_GENRES.TV.ActionAdventure}`, with_original_language: 'ja', sort_by: 'popularity.desc', 'vote_count.gte': 100, without_keywords: '198385,353318,214564,360629,284535,256466,356759' }] },
        { id: 'preset_anime_sports', name: 'Anime: Sport & Competizione', emoji: '🏐', category: "🏮 Solo Anime", type: 'series', presentation_strategy: 'popularity', queries: [{ strategy: 'discovery', with_genres: TMDB_GENRES.TV.Animation, with_keywords: '6075', with_original_language: 'ja', sort_by: 'vote_average.desc', 'vote_count.gte': 50 }] },

        // =============================================
        // --- 🏮 ANIME & ASIA (Classici & Film via Kitsu) ---
        // =============================================
        { id: 'preset_anime_classic', name: 'Anime Classici (\'80/\'90)', category: "🏮 Solo Anime", type: 'series', presentation_strategy: 'popularity', queries: [{ strategy: 'discovery', with_genres: TMDB_GENRES.TV.Animation, with_original_language: 'ja', 'first_air_date.gte': '1980-01-01', 'first_air_date.lte': '1999-12-31', sort_by: 'vote_average.desc', 'vote_count.gte': 50 }] },
        { id: 'preset_anime_00s', name: 'Anime Anni 2000', emoji: '💿', category: "🏮 Solo Anime", type: 'series', presentation_strategy: 'popularity', queries: [{ strategy: 'discovery', with_genres: TMDB_GENRES.TV.Animation, with_original_language: 'ja', 'first_air_date.gte': '2000-01-01', 'first_air_date.lte': '2009-12-31', sort_by: 'vote_average.desc', 'vote_count.gte': 50 }] },
        { id: 'preset_anime_movies_top', name: 'Capolavori Anime (Film)', emoji: '🏆', category: "🏮 Solo Anime", type: 'movie', presentation_strategy: 'popularity', queries: [{ strategy: 'discovery', with_genres: TMDB_GENRES.MOVIE.Animation, with_original_language: 'ja', sort_by: 'vote_average.desc', 'vote_count.gte': 200 }] },
        { id: 'preset_anime_movies_romance', name: 'Film Anime Romantici', emoji: '🎥', category: "🏮 Solo Anime", type: 'movie', presentation_strategy: 'popularity', queries: [{ strategy: 'discovery', with_genres: TMDB_GENRES.MOVIE.Animation, with_keywords: '9840', with_original_language: 'ja', sort_by: 'popularity.desc', 'vote_count.gte': 50 }] },
        ...
        { id: 'preset_apple_tv', name: 'Apple TV+', emoji: '🍎', category: "📺 Network & Piattaforme", type: 'series', presentation_strategy: 'popularity', queries: [{ strategy: 'discovery', with_networks: TMDB_NETWORKS.AppleTV, sort_by: 'vote_average.desc', 'vote_count.gte': 100 }] },
        // =============================================
        // --- ➕ NUOVI CATALOGHI ---
        // =============================================
        ...
        { id: 'preset_zombies', name: 'Zombie & Infezioni', emoji: '🧟', category: "👻 Brivido & Paura", type: 'series', presentation_strategy: 'popularity', queries: [{ strategy: 'discovery', with_keywords: '12377|4565|10483', with_genres: '27|10765', sort_by: 'popularity.desc', 'vote_count.gte': 10, without_keywords: '210024' }] },
        ...
        { id: 'preset_anime_kids_series', name: 'Anime per Bambini (Serie)', emoji: '🧸', category: '👨‍👩‍👧‍👦 Bambini & Famiglia', type: 'series', presentation_strategy: 'popularity', queries: [{ strategy: 'discovery', with_genres: `${TMDB_GENRES.TV.Animation},${TMDB_GENRES.TV.Kids}`, with_original_language: 'ja', sort_by: 'popularity.desc', 'vote_count.gte': 10 }] },
        { id: 'preset_anime_kids_movies', name: 'Anime per Bambini (Film)', emoji: '🧸', category: '👨‍👩‍👧‍👦 Bambini & Famiglia', type: 'movie', presentation_strategy: 'popularity', queries: [{ strategy: 'discovery', with_genres: TMDB_GENRES.MOVIE.Animation, with_keywords: '208349', with_original_language: 'ja', sort_by: 'popularity.desc', 'vote_count.gte': 10 }] },
...
const profileTemplates = [
    ...
    },
    {
        ...
        presets: [
            ...
            'preset_true_crime', 'preset_sports_underdog', 'preset_tv_thriller', 'preset_miniseries', 'preset_crime_procedural', 'preset_cyberpunk_series', 'preset_zombies', 'preset_mindfuck_series', 'preset_whodunit_series', 'preset_neo_noir_series'
        ]
    },
    {
        id: 'tpl_otaku',
