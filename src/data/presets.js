...
const getPresets = () => {
    ...
    const rawPresets = [
        ...
        { id: 'preset_sports_docs', name: 'Docuserie: Sport e Atleti', emoji: '🌍', category: "🌍 Documentari & Storie Vere", type: 'series', presentation_strategy: 'popularity', queries: [{ strategy: 'discovery', with_genres: TMDB_GENRES.TV.Documentary, with_keywords: '6075|258273', sort_by: 'popularity.desc', 'vote_count.gte': 5, without_keywords: '210024' }] },
