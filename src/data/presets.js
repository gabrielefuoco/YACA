...
const getPresets = () => {
    ...
    const rawPresets = [
        ...
        // =============================================
        { id: 'preset_mindfuck', name: 'Mindfuck & Plot Twists', emoji: '🤯', category: "🕵️ Crimine, Mistero & Thriller", type: 'movie', presentation_strategy: 'popularity', queries: [{ strategy: 'discovery', with_genres: '9648|53|878', with_keywords: '275311|374835|174089|335567|1453|169411|3298|6262|243230|362568|10854', sort_by: 'popularity.desc', 'vote_count.gte': 100 }] },
