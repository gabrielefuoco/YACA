...
const getPresets = () => {
    ...
    const rawPresets = [
        ...
        { id: 'preset_oscar_winners', name: 'Grandi Film Premiati', emoji: '🥇', category: "🔥 Top & Trend", type: 'movie', presentation_strategy: 'popularity', queries: [{ strategy: 'discovery', sort_by: 'popularity.desc', 'vote_average.gte': 7.8, 'vote_count.gte': 1000 }] },
