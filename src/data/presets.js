...
const getPresets = () => {
    ...
    const rawPresets = [
        ...
        { id: 'preset_anime_slice_of_life', isAnime: true, name: 'Anime: Slice of Life', emoji: '☕', category: "🏮 Solo Anime", type: 'series', presentation_strategy: 'popularity', queries: [{ strategy: 'discovery', with_genres: TMDB_GENRES.TV.Animation, with_keywords: '9914', with_original_language: 'ja', sort_by: 'vote_average.desc', 'vote_count.gte': 50 }] },
        { id: 'preset_anime_mecha', isAnime: true, name: 'Anime: Mecha & Robot', emoji: '🤖', category: "🏮 Solo Anime", type: 'series', presentation_strategy: 'popularity', queries: [{ strategy: 'discovery', with_genres: TMDB_GENRES.TV.Animation, with_keywords: '10046', with_original_language: 'ja', sort_by: 'popularity.desc' }] },
        ...
        { id: 'preset_anime_sports', isAnime: true, name: 'Anime: Sport & Competizione', emoji: '🏐', category: "🏮 Solo Anime", type: 'series', presentation_strategy: 'popularity', queries: [{ strategy: 'discovery', with_genres: TMDB_GENRES.TV.Animation, with_keywords: '6075', with_original_language: 'ja', sort_by: 'vote_average.desc', 'vote_count.gte': 50 }] },
