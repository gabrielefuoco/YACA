...
const getPresets = () => {
    ...
    const rawPresets = [
        ...
        { id: 'preset_neo_noir', name: 'Neo-Noir & Detective Oscuri', emoji: '🚬', category: "🕵️ Crimine, Mistero & Thriller", type: 'movie', presentation_strategy: 'popularity', queries: [{ strategy: 'discovery', with_genres: `${TMDB_GENRES.MOVIE.Crime}|${TMDB_GENRES.MOVIE.Mystery}`, with_keywords: '1471|207317|209210', sort_by: 'popularity.desc', 'vote_count.gte': 50 }] },
        { id: 'preset_neo_noir_series', name: 'Neo-Noir & Detective Oscuri (Serie)', emoji: '🚬', category: "🕵️ Crimine, Mistero & Thriller", type: 'series', presentation_strategy: 'popularity', queries: [{ strategy: 'discovery', with_genres: `${TMDB_GENRES.TV.Crime}|${TMDB_GENRES.TV.Drama}`, with_keywords: '1471|207317|209210', sort_by: 'popularity.desc', 'vote_count.gte': 15, without_keywords: '210024' }] },
        ...
        { id: 'preset_anime_movies_romance', isAnime: true, name: 'Film Anime Romantici', emoji: '🎥', category: "🏮 Solo Anime", type: 'movie', presentation_strategy: 'popularity', queries: [{ strategy: 'discovery', with_genres: TMDB_GENRES.MOVIE.Animation, with_keywords: '9840', with_original_language: 'ja', sort_by: 'popularity.desc', 'vote_count.gte': 50 }] },
