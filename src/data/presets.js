...
const getPresets = () => {
    ...
    const rawPresets = [
        ...
        { id: 'preset_teen_drama', name: 'Teen Drama & Coming of Age', emoji: '🎒', category: "🍿 Serata Leggera & Risate", type: 'series', presentation_strategy: 'popularity', queries: [{ strategy: 'discovery', with_genres: TMDB_GENRES.TV.Drama, without_genres: '35', with_keywords: '6270|10683|11156|315570', sort_by: 'popularity.desc', 'vote_count.gte': 20, without_keywords: '210024' }] },
        ...
        { id: 'preset_fairy_tales', name: 'Fiabe, Castelli & Principesse', emoji: '🧚', category: '👨‍👩‍👧‍👦 Bambini & Famiglia', type: 'movie', presentation_strategy: 'popularity', queries: [{ strategy: 'discovery', with_genres: 10751, with_keywords: '3205|3095|12554', without_keywords: '210024', sort_by: 'popularity.desc', 'vote_count.gte': 50 }] },
