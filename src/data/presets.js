...
const getPresets = () => {
    ...
    const rawPresets = [
        ...
        { id: 'preset_doc_food_travel', name: 'Cibo, Viaggi & Alta Cucina', emoji: '🍔', category: "🌍 Documentari & Storie Vere", type: 'series', presentation_strategy: 'popularity', queries: [{ strategy: 'discovery', with_genres: TMDB_GENRES.TV.Documentary, with_keywords: '1918|9935|10637|233721|6513', sort_by: 'popularity.desc', 'vote_count.gte': 5, without_keywords: '210024' }] },
