...
const getPresets = () => {
    ...
    const rawPresets = [
        ...
        { id: 'preset_cyberpunk', name: 'Cyberpunk & Futuro Distopico', emoji: '🤖', category: "🐉 Fantascienza & Fantasy", type: 'movie', presentation_strategy: 'popularity', queries: [{ strategy: 'discovery', with_genres: `${TMDB_GENRES.MOVIE.SciFi}|${TMDB_GENRES.MOVIE.Action}`, with_keywords: '12190|4565|156556', sort_by: 'vote_average.desc', 'vote_count.gte': 100 }] },
        ...
        { id: 'preset_tv_dystopia', name: 'Futuri Distopici', emoji: '🏆', category: "🐉 Fantascienza & Fantasy", type: 'series', presentation_strategy: 'popularity', queries: [{ strategy: 'discovery', with_genres: TMDB_GENRES.TV.SciFiFantasy, with_keywords: '10053|4565', sort_by: 'popularity.desc', 'vote_count.gte': 10, without_keywords: '210024' }] },
