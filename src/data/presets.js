...
const getPresets = () => {
    ...
    const rawPresets = [
        ...
        { id: 'preset_teen_drama_comedy', name: 'High School & Teen Drama', emoji: '😂', category: "🍿 Serata Leggera & Risate", type: 'series', presentation_strategy: 'popularity', queries: [{ strategy: 'discovery', with_genres: TMDB_GENRES.TV.Comedy, with_keywords: '6270|10683', sort_by: 'popularity.desc', 'vote_count.gte': 50, without_keywords: '210024' }] },
