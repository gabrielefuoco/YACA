  ...
  return (
    <div className="flex flex-col w-full gap-8">
      <div className="flex flex-col gap-1">
        <h1 className="text-zinc-900 dark:text-zinc-100 text-3xl font-black leading-tight tracking-tight text-center md:text-left">Dashboard</h1>
        <p className="text-zinc-500 dark:text-zinc-400 text-sm text-center md:text-left">Gestisci i tuoi profili e personalizza i cataloghi multimediali</p>
      </div>
      ...
      <section className="flex flex-col gap-6 items-center w-full mt-4">
        <div className="inline-flex p-1 bg-zinc-100 dark:bg-zinc-800/60 rounded-xl w-fit mb-4 mx-auto overflow-x-auto max-w-full hide-scrollbar">
          {tabsItems.map(({ id, label, icon }) => (
            <button
              ...
              className={activeTab === id
                ...
                : 'px-6 md:px-8 py-2.5 text-sm font-medium text-zinc-500 dark:text-zinc-400 hover:text-primary transition-colors flex items-center gap-2 whitespace-nowrap'
              }
            >
