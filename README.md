...
2. Vai nella sezione **Billing** e aggiungi un metodo di pagamento (Mistral funziona a consumo e i costi per questo addon sono irrisori, gratuiti o pochi centesimi in base al tier).
